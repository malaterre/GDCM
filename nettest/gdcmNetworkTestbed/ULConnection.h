...
namespace gdcm{
  namespace primitives{
    ...
    public:
      ...
      //given a particular action, perform that action if the current state of the connection
      //warrants it.  The result will be indicated by the return ULEvent.
      virtual ULEvent* DoAction(ULAction* inAction);
