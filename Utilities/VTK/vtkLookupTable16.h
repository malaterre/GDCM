...
#include "vtkUnsignedShortArray.h" // Needed for inline method
...
class VTK_COMMON_EXPORT vtkLookupTable16 : public vtkScalarsToColors
{
public:
  // Description:
  ...
  vtkTypeRevisionMacro(vtkLookupTable16,vtkScalarsToColors);
  ...
  unsigned short *WritePointer(const vtkIdType id, const int number);
  ...
  void SetTable(vtkUnsignedShortArray *);
  vtkGetObjectMacro(Table,vtkUnsignedShortArray);
  ...
  void DeepCopy(vtkLookupTable16 *lut);
...
//----------------------------------------------------------------------------
inline unsigned short *vtkLookupTable16::WritePointer(const vtkIdType id, 
                                                   const int number)
{
