    ...
    wxFrame(parent, id, title, pos, size, wxDEFAULT_FRAME_STYLE)
{
    ...
    frame_1_menubar->Append(wxglade_tmp_menu_1, wxT("item"));
    wxMenu* wxglade_tmp_menu_2 = new wxMenu();
    frame_1_menubar->Append(wxglade_tmp_menu_2, wxT("item"));
    wxMenu* wxglade_tmp_menu_3 = new wxMenu();
    frame_1_menubar->Append(wxglade_tmp_menu_3, wxT("item"));
