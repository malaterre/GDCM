...
int main(int argc, char *argv[])
{
  ...
  static const char datatyperef[] = "UDM_USD_DATATYPE_DIN_2D_ECHO";
  if( strncmp(bvdatatype->GetPointer(), datatyperef, sizeof(datatyperef)) != 0 ) return 1;
  ...
  if( strncmp(bv->GetPointer(), "ZLib", 4) != 0 ) return 1;
