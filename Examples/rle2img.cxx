...
void delta_decode(const char *inbuffer, unsigned short *outbuffer, unsigned short *ref, int length)
{
  unsigned short t = 0;
  int i;
  int j;
...
int main(int argc, char *argv [])
{
  ...
  memset(ref,0,131072);
  delta_decode(bv2->GetPointer(), (unsigned short *)ref, 0, bv2->GetLength());
