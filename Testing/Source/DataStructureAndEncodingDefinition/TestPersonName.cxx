...
int TestPersonName(int, char *[])
{
  typedef gdcm::PersonName PN;
	...
	PN pn0;
	std::cout << "NumComp:" << pn0.GetNumberOfValidComponents() << std::endl;
  pn0.SetComponents();
	std::cout << "NumComp:" << pn0.GetNumberOfValidComponents() << std::endl;
	pn0.Print( std::cout );
  std::cout << std::endl;
	...
	PN pn00 = { "" };
	std::cout << "NumComp:" << pn00.GetNumberOfValidComponents() << std::endl;

	PN pn1 = { "abc123", "def", "ghi", "klm", "opq" };
	pn1.Print( std::cout );
	std::cout << std::endl;
	std::cout << "NumComp:" << pn1.GetNumberOfValidComponents() << std::endl;

	PN pn2 = { "malaterre", "mathieu olivier patrick"};
	pn2.Print( std::cout );
	std::cout << std::endl;
	std::cout << "NumComp:" << pn2.GetNumberOfValidComponents() << std::endl;
...
// Rev. John Robert Quincy Adams, B.A. M.Div. “Adams^John Robert Quincy^^Rev.^B.A. M.Div.” [One family name; three given names; no middle name; one prefix; two suffixes.]
	...
	pn3.Print( std::cout );
	std::cout << std::endl;
	std::cout << "NumComp:" << pn3.GetNumberOfValidComponents() << std::endl;
// Susan Morrison-Jones, Ph.D., Chief Executive Officer “Morrison-Jones^Susan^^^Ph.D., Chief Executive Officer” [Two family names; one given name; no middle name; no prefix; two suffixes.]
	...
	pn4.Print( std::cout );
	std::cout << std::endl;
	std::cout << "NumComp:" << pn4.GetNumberOfValidComponents() << std::endl;
...
// John Doe “Doe^John” [One family name; one given name; no middle name, prefix, or suffix. Delimiters have been omitted for the three trailing null components.]
	...
	pn5.Print( std::cout );
	std::cout << std::endl;
	std::cout << "NumComp:" << pn5.GetNumberOfValidComponents() << std::endl;
...
//human, whose responsible party family name is Smith, and whose own name is Fluffy]
	...
	pn6.Print( std::cout );
	std::cout << std::endl;
	std::cout << "NumComp:" << pn6.GetNumberOfValidComponents() << std::endl;
//ABC Farms^Running on Water [A horse whose responsible organization is named ABC Farms, and whose name is “Running On Water”]
	...
	pn7.Print( std::cout );
	std::cout << std::endl;
	std::cout << "NumComp:" << pn7.GetNumberOfValidComponents() << std::endl;
