...
//{ "PET-cardio-Multiframe-Papyrus.dcm (could be read)},
...
//{ "LIBIDO-24-ACR_NEMA-Rectangle.dcm (could be read)},
...
//{ "LIBIDO-16-ACR_NEMA-Volume.dcm (could be read)},
...
//{ "JDDICOM_Sample2-dcmdjpeg.dcm (could be read)},
...
//{ "MR-MONO2-12-angio-an1.acr (could be read)},
//{ "README (could not be read)},
...
//{ "GE_CT_With_Private_compressed-icon.README.txt (could not be read)},
{ "D_CLUNIE_RG1_RLE.dcm","1.2.840.10008.5.1.4.1.1.1"},
//{ "JDDICOM_Sample2.dcm (could be read)},
{ "SIEMENS_MAGNETOM-12-MONO2-FileSeq3.dcm","1.2.840.10008.5.1.4.1.1.4"},
//{ "MR_Philips_Intera_SwitchIndianess_noLgtSQItem_in_trueLgtSeq.README.txt (could not be read)},
...
//{ "LIBIDO-8-ACR_NEMA-Lena_128_128.acr (could be read)},
{ "D_CLUNIE_RG3_JPLL.dcm","1.2.840.10008.5.1.4.1.1.1"},
{ "SIEMENS_CSA2.dcm","1.2.840.10008.5.1.4.1.1.4"},
//{ "SIEMENS_GBS_III-16-ACR_NEMA_1-ULis2Bytes.dcm (could be read)},
...
//{ "libido1.0-vol.acr (could be read)},
//{ "MR_Philips_Intera_PrivateSequenceExplicitVR_in_SQ_2001_e05f_item_wrong_lgt_use_NOSHADOWSEQ.README.txt (could not be read)},
...
//{ "ImageRecap.txt (could not be read)},
...
//{ "MR_Philips-Intera_BreaksNOSHADOW.README.txt (could not be read)},
//{ "CT-MONO2-12-lomb-an2.acr.README.txt (could not be read)},
{ "dicomdir_With_embedded_icons", "1.2.840.10008.1.3.10"},
//{ "SIEMENS_MAGNETOM-12-ACR_NEMA_2-Modern.dcm (could be read)},
...
//{ "gdcm-MR-SIEMENS-16-2.acr (could be read)},
...
//{ "JDDICOM_Sample2-dcmdjpeg.txt (could not be read)},
...
//{ "CT-MONO2-12-lomb-an2.acr (could be read)},
