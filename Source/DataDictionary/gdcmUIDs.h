...
RFC2557MIMEencapsulationRetired = 42, // RFC 2557 MIME encapsulation
XMLEncodingRetired = 43, // XML Encoding
...
GeneralPurposeWorklistManagementMetaSOPClassRetired = 318, // General Purpose Worklist Management Meta SOP Class
GeneralPurposeWorklistInformationModelFINDRetired = 319, // General Purpose Worklist Information Model - FIND
GeneralPurposeScheduledProcedureStepSOPClassRetired = 320, // General Purpose Scheduled Procedure Step SOP Class
GeneralPurposePerformedProcedureStepSOPClassRetired = 321, // General Purpose Performed Procedure Step SOP Class
InstanceAvailabilityNotificationSOPClass = 322, // Instance Availability Notification SOP Class
RTBeamsDeliveryInstructionStorageTrialRetired = 323, // RT Beams Delivery Instruction Storage - Trial
RTConventionalMachineVerificationTrialRetired = 324, // RT Conventional Machine Verification - Trial
RTIonMachineVerificationTrialRetired = 325, // RT Ion Machine Verification - Trial
UnifiedWorklistandProcedureStepServiceClassTrialRetired = 326, // Unified Worklist and Procedure Step Service Class - Trial
