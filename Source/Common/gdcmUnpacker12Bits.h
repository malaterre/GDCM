 ...
 *
 * This class has no purpose in general purpose DICOM implementation. However to be able
 * to cope with some early ACR-NEMA file generated by a well-known private vendor, one
 * would need to unpack 12bits Stored Pixel Value into a more standard 16bits Stored Pixel Value.
 *
 * \see Rescaler
 */
