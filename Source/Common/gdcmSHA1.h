...
public :
  ...
  static bool Compute(const char *buffer, unsigned long buf_len, const char digest[20*2+1]);

  static bool ComputeFile(const char *filename, const char digest_str[20*2+1]);
