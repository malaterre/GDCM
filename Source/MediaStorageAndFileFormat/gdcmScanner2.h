...
=========================================================================*/
#ifndef GDCMSCANNER2_H
#define GDCMSCANNER2_H
 ...
 * \li EndEvent
 */
class GDCM_EXPORT Scanner2 : public Subject
{
...
public:
  ...
  PrivateMappingType const & GetPrivateMappings() const { return PrivateMappings; }
  ...
  static SmartPointer<Scanner2> New() { return new Scanner2; }
...
//-----------------------------------------------------------------------------
inline std::ostream& operator<<(std::ostream &os, const Scanner2 &s)
{
  s.Print( os );
  return os;
}
