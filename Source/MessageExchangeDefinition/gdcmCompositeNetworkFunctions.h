...
public:
  ...
  static bool CEcho( const char *remote, uint16_t portno, const char *aetitle = GDCM_NULLPTR,
    const char *call = GDCM_NULLPTR );
  ...
  static bool CMove( const char *remote, uint16_t portno, const BaseRootQuery* query,
    uint16_t portscp, const char *aetitle = GDCM_NULLPTR,
    const char *call = GDCM_NULLPTR, const char *outputdir = GDCM_NULLPTR);
  ...
  static bool CFind( const char *remote, uint16_t portno, 
    ...
    const char *aetitle = GDCM_NULLPTR,
    const char *call = GDCM_NULLPTR );
  ...
  static bool CStore( const char *remote, uint16_t portno,
    ...
    const char *aetitle = GDCM_NULLPTR, const char *call = GDCM_NULLPTR);
};
