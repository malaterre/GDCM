...
TYPETOENCODING(AE,VRASCII ,float)
TYPETOENCODING(AS,VRASCII ,char)
TYPETOENCODING(AT,VRBINARY,Tag)
TYPETOENCODING(CS,VRASCII ,String)
TYPETOENCODING(DA,VRASCII ,float)
TYPETOENCODING(DS,VRASCII ,float)
TYPETOENCODING(DT,VRASCII ,float)
