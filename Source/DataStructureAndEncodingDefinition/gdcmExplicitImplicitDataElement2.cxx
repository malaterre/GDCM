...
=========================================================================*/
#include "gdcmExplicitImplicitDataElement2.h"
...
VL ExplicitImplicitDataElement2::GetLength() const
{
  if( ValueLengthField.IsUndefined() )
    ...
    if( sq )
      ...
      return TagField.GetLength() + VRField.GetLength() + 
        ValueLengthField.GetLength() + sq->ComputeLength<ExplicitImplicitDataElement2>();
      }
